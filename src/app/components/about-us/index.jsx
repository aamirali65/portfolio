...
const About = () => {
  ...
  return (
    <main className='bg-primary pb-10' id='about'>
      <div id="title" className='text-center' data-aos="fade-up" data-aos-delay="300">
      ...
      <div data-aos="fade-up" data-aos-delay="300" id="aboutz" className='mx-4 md:mx-10 lg:mx-20 xl:mx-40 flex flex-col gap-10 md:flex-row mt-10 justify-between items-center'>
