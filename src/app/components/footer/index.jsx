  ...
  return (
    <main className='bg-primary py-8'>
        <div id="footer" className='flex flex-col justify-center items-center text-center'>
            ...
            <div id="list" className="flex text-white gap-5 md:gap-14 my-7 font-stock">
                <a href="#about" className='font-body md:text-xl hover:text-blue-500'>About</a>
                <a href="#skill" className='font-body md:text-xl hover:text-blue-500'>Skills</a>
                <a href="#project" className='font-body md:text-xl hover:text-blue-500'>Projects</a>
                <a href="#experience" className='font-body md:text-xl hover:text-blue-500'>Experience</a>
                <a href="#contact" className='font-body md:text-xl hover:text-blue-500'>Contact ME 🚀</a>
            </div>
            ...
            <span className='font-stock text-white mt-10 font-body md:px-0 px-2'>© 2024 Aamir Almani. All rights reserved.</span>
        </div>
    </main>
  )
}
